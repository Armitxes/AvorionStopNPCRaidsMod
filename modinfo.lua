...
meta =
{
    ...
    name = "Stop NPC Raids | Armitxes Network",

    -- Title of your mod that will be displayed to players
    title = "Stop NPC Raids | Armitxes Network",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Stop random NPC raids in sectors.\nStory, missions (Swoks, AI, Bliks, Guardian, etc), merchants & artifacts stay available.\n\nWorks in single- and multiplayer.\nHost- / Serverside only mod (other players won't have to download for the mod to work).\n\nDiscord: https://armitxes.net/discord",
    ...
    contact = "https://armitxes.net/discord or support@armitxes.net",
}
